...
function renderCart() {
  ...
  <div class="cart-row">
    ...
    <span class="cart-price"><b>${formatRupiah(item.price)}</b></span>
    <div class="cart-qty">
...
function bayarDanCetak() {
  ...
  // Simpan riwayat & struk terakhir
  riwayat.push(transaksi);
  localStorage.setItem("riwayat", JSON.stringify(riwayat));
  localStorage.setItem("strukTerakhir", JSON.stringify(transaksi));

  // Reset kasir untuk transaksi berikutnya
  cart = {};
  ...
  // Cetak struk
  const win = window.open("struk/index.html", "_blank");

  // Tunggu struk selesai dicetak → kembali ke kasir
